...
class edificacao extends Base {
    ...
    public function salvarEdificacao(){
        ...
        if($this->input->post('id')){
            ...
            redirect($this->session->userdata('indexPHP').'telecom/edificacao/fichaEdificacao/'.$this->input->post('id'));
    ...
    public function reEnviarOrdemEmail($id){
        ...
        if(!$dados){
            ...
            redirect($this->session->userdata('indexPHP').'telecom/edificacao/pesqEdificacao');
        }
    ...
    public function deletaEdificacao(){
        ...
        redirect(base_url('telecom/edificacao/pesqEdificacao'));
