...
class viabilidadeRespHist extends MX_Controller {
    ...
    public function envioEmail($id, $tipo = 'Cadastrada'){
        ...
        $titulo = utf8_decode("[Histórico de viabilidade] - (".$dados->n_solicitacao.") - Operação: ".$dados->unidade);
        $para = 'equipe.sistemas@simtv.com.br';
        
        $msg = "<strong>[Histórico de viabilidade] - (".$dados->n_solicitacao.") - Operação: ".$dados->unidade."</strong><br>";
        $msg .= "Foi gravado um histórico da viabilidade ".$dados->n_solicitacao." da Operação ".$dados->unidade.".<br><br>";
