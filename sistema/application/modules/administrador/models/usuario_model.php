...
class Usuario_model extends CI_Model{
    ...
    */
	public function dadosUsuario($cd){
        ...
        $this->db->select('usuario.cd_usuario, login_usuario, matricula_usuario, nome_usuario, rg_usuario, cpf_usuario, email_usuario, nome_usuario, cd_cargo, cd_departamento, cd_perfil, status_config_usuario, cd_estado, cd_unidade, tipo_usuario, index_php_usuario');
    ...
    */
     ...
     */
    public function psqUsuarios($matricula = null, $nome = null, $departamento = null, $status = null, $pagina = null, $mostra_por_pagina = null, $sort_by = null, $sort_order = null){
        ...
        if($departamento != '0'){
            #$this->db->like('nome_perfil', $nome); 
            $condicao = "usuario.cd_departamento = ".$departamento;
            $this->db->where($condicao);
        }
     ...
     */
    public function psqQtdUsuarios($matricula = null, $nome = null, $departamento = null, $status = null){
    ...
    public function autenticaUsuario(){
        ...
        $this->db->select('usuario.cd_usuario, login_usuario, matricula_usuario, nome_usuario, email_usuario, cd_departamento, cd_unidade, cd_cargo, cd_perfil, status_usuario AS status_pai, status_config_usuario AS status_filho, status_chat_usuario, index_php_usuario, data_chat_usuario, CURRENT_TIMESTAMP() AS data_hora_atual');
