...
Date: 2017-10-23 09:46:08
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `data_desativacao`
-- ----------------------------
DROP TABLE IF EXISTS `data_desativacao`;
CREATE TABLE `data_desativacao` (
...
`mes_reajuste`  smallint(6) NULL DEFAULT NULL ,
`idIndiceReajuste`  int(11) NULL DEFAULT NULL ,
`idRegraReajuste`  int(10) UNSIGNED NULL DEFAULT NULL ,
...
`designacao`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`data_inicio`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`data_fim`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_contrato`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`men_sem_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`servico`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_sem_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_com_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
ROW_FORMAT=Compact
...
-- ----------------------------
-- Table structure for `valores_atualizados`
-- ----------------------------
DROP TABLE IF EXISTS `valores_atualizados`;
CREATE TABLE `valores_atualizados` (
`designacao`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_sem_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_com_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL 
)
...
-- ----------------------------
-- Table structure for `valores_corrigir`
-- ----------------------------
DROP TABLE IF EXISTS `valores_corrigir`;
CREATE TABLE `valores_corrigir` (
`designacao`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_contrato`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`mens_sem_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_sem_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`valor_com_imp`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`obs`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL 
)
...
DELIMITER ;;
CREATE DEFINER=`sistemas`@`%` FUNCTION `diasAtivacaoFaturar`(VARContrato VARCHAR(255),VARUltimoDia DATE,VARDataAtivacao DATE) RETURNS int(11)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`sistemas`@`%` FUNCTION `diasCancelFaturar`(VARDataCanc DATE, VARPrimDiaMes DATE) RETURNS int(11)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`sistemas`@`%` FUNCTION `valorComImposto`(VARcampo NUMERIC(15,3),VARisencaoICMS CHAR(3), VARservico INT, VARufOrigem INT, VARfaturadoPOR INT, VARestatal CHAR(3)) RETURNS decimal(15,3)
BEGIN
...
-- ----------------------------
ALTER TABLE `tcom_analise_financ` AUTO_INCREMENT=15;
...
-- ----------------------------
ALTER TABLE `tcom_circuito` AUTO_INCREMENT=8448;
...
-- ----------------------------
ALTER TABLE `tcom_cliente` AUTO_INCREMENT=4961;
...
-- ----------------------------
ALTER TABLE `tcom_cliente_end` AUTO_INCREMENT=29604;
...
-- ----------------------------
ALTER TABLE `tcom_cliente_telefone` AUTO_INCREMENT=142;
...
-- ----------------------------
ALTER TABLE `tcom_contrato` AUTO_INCREMENT=8484;
...
-- ----------------------------
ALTER TABLE `tcom_contrato_anexo` AUTO_INCREMENT=1048;
...
-- ----------------------------
ALTER TABLE `tcom_contrato_circuito` AUTO_INCREMENT=6429;
...
-- ----------------------------
ALTER TABLE `tcom_contrato_equip` AUTO_INCREMENT=36;
...
-- ----------------------------
ALTER TABLE `tcom_contrato_valor` AUTO_INCREMENT=7531;
...
-- ----------------------------
ALTER TABLE `tcom_debcred` AUTO_INCREMENT=6;
...
-- ----------------------------
ALTER TABLE `tcom_delin` AUTO_INCREMENT=17317;
...
-- ----------------------------
ALTER TABLE `tcom_edificacao` AUTO_INCREMENT=28730;
...
-- ----------------------------
ALTER TABLE `tcom_imposto` AUTO_INCREMENT=791;
...
CREATE INDEX `fk_idIndiceReajuste` ON `tcom_indice_reajuste_hist`(`idIndiceReajuste`) USING BTREE ;

-- ----------------------------
-- Auto increment value for `tcom_indice_reajuste_hist`
-- ----------------------------
ALTER TABLE `tcom_indice_reajuste_hist` AUTO_INCREMENT=5;
...
-- ----------------------------
ALTER TABLE `tcom_log_contrato` AUTO_INCREMENT=5419;

-- ----------------------------
-- Auto increment value for `tcom_log_contrato_valor`
-- ----------------------------
ALTER TABLE `tcom_log_contrato_valor` AUTO_INCREMENT=1643;
...
-- ----------------------------
ALTER TABLE `tcom_node` AUTO_INCREMENT=3442;
...
-- ----------------------------
ALTER TABLE `tcom_oper` AUTO_INCREMENT=724;
...
-- ----------------------------
ALTER TABLE `tcom_oper_cobr` AUTO_INCREMENT=3772;
...
-- ----------------------------
ALTER TABLE `tcom_oper_fat` AUTO_INCREMENT=76;
...
-- ----------------------------
ALTER TABLE `tcom_oper_inst` AUTO_INCREMENT=3802;
...
-- ----------------------------
ALTER TABLE `tcom_regra_reajuste` AUTO_INCREMENT=11;

-- ----------------------------
-- Indexes structure for table tcom_servico
-- ----------------------------
CREATE UNIQUE INDEX `idx_id_tcom_servico` ON `tcom_servico`(`id`) USING BTREE ;
...
-- ----------------------------
ALTER TABLE `tcom_taxa_digital` AUTO_INCREMENT=132;
...
-- ----------------------------
ALTER TABLE `tcom_titulo_fat` AUTO_INCREMENT=686;
...
-- ----------------------------
ALTER TABLE `tcom_viab` AUTO_INCREMENT=5937;
...
-- ----------------------------
ALTER TABLE `tcom_viab_md_end` AUTO_INCREMENT=19;
...
-- ----------------------------
ALTER TABLE `tcom_viab_pend` AUTO_INCREMENT=145;
...
-- ----------------------------
ALTER TABLE `tcom_viab_resp` AUTO_INCREMENT=6038;
...
-- ----------------------------
ALTER TABLE `tcom_viab_resp_hist` AUTO_INCREMENT=269384;
