    ...
    <!-- FIM Modal Copiar perfil -->
            ...
            <div class="col-lg-12">
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('perfil/pesquisarPerfil',$data);
                            ...
                            $botaoCadastrar = (in_array(18, $this->session->userdata('permissoes')))? "<a href='".base_url('perfil/ficha')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                ...
                foreach($perfis as $per){
                    ...
                    $botaoEditar = (in_array(18, $this->session->userdata('permissoes')))? '<a title="Editar" href="'.base_url('perfil/ficha/'.$per->cd_perfil).'" class="glyphicon glyphicon glyphicon-pencil"></a>': '';
