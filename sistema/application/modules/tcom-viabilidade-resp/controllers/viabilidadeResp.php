...
class viabilidadeResp extends Base {
    ...
    public function msgEmailResposta($id, $tipo = false){
        ...
        $idContrato = ($dados['viabResp']->idContratoAtual)? $dados['viabResp']->idContratoAtual : $dados['viabResp']->idContrato;

        $dados['circuito'] = $this->$modelAssunto->dadosCircuitoContrato($idContrato);
        $dados['tipo'] = $tipo;
        $dados['dirDownload'] = self::linkDownload;
