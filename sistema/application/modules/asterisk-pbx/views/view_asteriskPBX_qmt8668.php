...
$this->session->set_userdata('current_menu_pbx', 4);
?>
...
<html lang="en">
    ...
    //Carrega como padrão os parâmetros de "DataInicio" e "DataFinal" para chamada do Ajax:
        function load_page_data(dataInicio = '', dataFinal = ''){
            ...
            var tituloPBX = 'Receptivo 4003-8668 ';
            ...
            var jsonData = $.ajax({
                url: "/sistema/dashboard/telefonia/dadosTelefonia40038668/" + dataInicio + "/" + dataFinal,
                dataType: "json",
                async: false
            }).responseText;
