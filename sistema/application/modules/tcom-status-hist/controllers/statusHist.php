...
class statusHist extends Base {
     
     private $logDados;
     const modulo = 'tcom-status-hist';
     const controller = 'statusHist';
     const pastaView = 'statusHist';
     const tabela = 'tcom_status_hist';
     const assunto = 'Status Historico Viabilidade';
     const modelAssunto = 'statushist';
     const perModulo = 274;
     const perPesq = 327;
     const perCadEdit = 328;
     const perDeletar = 329;
     const perDefRecebeEmail = 330;
    ...
    public function __construct(){
        ...
        $this->load->model('statushist_model',self::modelAssunto);
        
        $modelAssunto = self::modelAssunto;
        $this->$modelAssunto->setPerDefRecebeEmail(self::perDefRecebeEmail);
    ...
    public function ficha($id = false){
        ...
        $dados['perDefRecebeEmail'] = self::perDefRecebeEmail;       
