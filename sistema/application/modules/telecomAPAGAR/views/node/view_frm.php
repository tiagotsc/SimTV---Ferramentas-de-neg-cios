            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    ...
                    <?php   
                    	...
                    	echo form_open('telecom/node/salvarNode',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
             
                    		echo form_fieldset("Ficha node<a href='".base_url($this->session->userdata('indexPHP').'telecom/node/pesqNode')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
...
$(document).ready(function(){ 
    ...
    $("#cd_unidade").change(function(){
        ...
        if($(this).val() != ''){
            ...
            $.ajax({
              type: "POST",
              url: '<?php echo base_url().$this->session->userdata('indexPHP'); ?>telecom/ajaxTelecom/carregaNodesSiga',
              data: {
                permissor: perm[0],
              },
              dataType: "json",
