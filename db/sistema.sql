...
-- ----------------------------
ALTER TABLE `anatel_meta_res` AUTO_INCREMENT=2500;
...
-- ----------------------------
ALTER TABLE `anatel_res` AUTO_INCREMENT=41229;
...
-- ----------------------------
ALTER TABLE `anatel_resp_indicador` AUTO_INCREMENT=783;
...
-- ----------------------------
ALTER TABLE `arquivo_retorno` AUTO_INCREMENT=15983;
...
-- ----------------------------
ALTER TABLE `config_usuario` AUTO_INCREMENT=2412;
...
-- ----------------------------
ALTER TABLE `conteudo_arquivo_retorno` AUTO_INCREMENT=4848861;
...
-- ----------------------------
ALTER TABLE `email_grupo_recebe` AUTO_INCREMENT=1413;
...
-- ----------------------------
ALTER TABLE `email_recebe` AUTO_INCREMENT=1552;
...
-- ----------------------------
ALTER TABLE `excluido_arquivo_retorno` AUTO_INCREMENT=20917;
...
-- ----------------------------
ALTER TABLE `grafico` AUTO_INCREMENT=13;
...
-- ----------------------------
ALTER TABLE `grafico_acesso` AUTO_INCREMENT=4521;
...
-- ----------------------------
ALTER TABLE `menu` AUTO_INCREMENT=47;
...
-- ----------------------------
ALTER TABLE `menu_lateral` AUTO_INCREMENT=54;
...
-- ----------------------------
ALTER TABLE `perfil` AUTO_INCREMENT=55;
...
-- ----------------------------
ALTER TABLE `permissao` AUTO_INCREMENT=401;
...
-- ----------------------------
ALTER TABLE `permissao_perfil` AUTO_INCREMENT=39297;
...
-- ----------------------------
ALTER TABLE `relatorio` AUTO_INCREMENT=213;
...
-- ----------------------------
ALTER TABLE `relatorio_acesso` AUTO_INCREMENT=8557;
...
-- ----------------------------
ALTER TABLE `relatorio_parametro` AUTO_INCREMENT=714;
