            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    ...
                    #echo date('N', strtotime(date('2016-04-05')));
                        ...
                        echo form_open_multipart('tcom-edificacao/edificacao/salvar',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
             
                    		echo form_fieldset("Ficha edifica&ccedil;&atilde;o<a href='".base_url('tcom-edificacao/edificacao/pesq')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
...
$.fn.existeEndereco = function() {  
    $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>tcom-edificacao/ajaxEdificacao/existeEndereco',
      data: {
        <?php if($id){ ?>
        id: <?php echo $id;?>,
        <?php } ?>
      ...
      dataType: "json",
      /*error: function(res) {
        $("#resMarcar").html('<span>Erro de execuï¿½ï¿½o</span>');
      },*/
      success: function(res) {
        if(res.length > 0){
            ...
            $.each( res, function() {
              links += '<strong><a target="_blank" href="<?php echo base_url('tcom-edificacao/edificacao/ficha'); ?>/'+this.id+'">Contrato - '+this.contrato+'</a></strong><br>';
            });
...
// Busca o endereï¿½o de acordo com o CEP
$("#cep").keyup(function(){
...
$(document).ready(function(){ 
    ...
    $("#pesq").click(function(){
        ...
        if($("#cd_unidade").val() == '' || $("#origem").val() == '' || $("#contrato").val() == ''){
            ...
            $.ajax({
              type: "POST",
              url: '<?php echo base_url(); ?>tcom-edificacao/ajaxEdificacao/'+urlParte,
              data: {
                permissor: perm[0],
