            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php              
                        ...
                        echo form_open('telefonia/apagaPlano',$data);
            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('telefonia/pesqPlano',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
                            
                            $botaoCadastrar = (in_array(16, $this->session->userdata('permissoes')))? "<a href='".base_url('telefonia/fichaPlano')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                            
                    		echo form_fieldset("Pesquisar plano".$botaoCadastrar, $attributes);
                    		  
                                echo '<div class="row">';
                                
                                    echo '<div class="col-md-6">';
                                    #print_r(array_keys($listaBancos));
                                    echo form_label('Nome do plano', 'nome');
                                ...
                                echo form_submit("btn_cadastro",utf8_encode("Pesquisar plano"), 'class="btn btn-primary pull-right"');
                                echo '</div>';
                ...
                foreach($campos as $nome => $display){
                    ...
                    $colunas[] = anchor("telefonia/pesqPlano/".(($postNome == '')? '0': $postNome)."/".(($postOperadora == '')? '0': $postOperadora)."/".(($postStatus == '')? '0': $postStatus)."/".$nome."/".(($sort_order == 'asc' && $sort_by == $nome) ? 'desc' : 'asc') ,$display.$icoAscDesc, array('class' => $class));
                ...
                foreach($dados as $da){
                    ...
                    #$cell[$contCell++] = array('data' => $da->cd_telefonia_plano);
                    ...
                    $botaoEditar = (in_array(218, $this->session->userdata('permissoes')))? '<a title="Editar" href="'.base_url('telefonia/fichaPlano/'.$da->cd_telefonia_plano).'" class="glyphicon glyphicon glyphicon-pencil"></a>': '';
                    $botaoExcluir = (in_array(219, $this->session->userdata('permissoes')))? '<a title="Apagar" href="#" onclick="apagarRegistro('.$da->cd_telefonia_plano.',\''.$da->nome.'\')" data-toggle="modal"  data-target="#apaga" class="glyphicon glyphicon glyphicon glyphicon-remove"></a>': '';
