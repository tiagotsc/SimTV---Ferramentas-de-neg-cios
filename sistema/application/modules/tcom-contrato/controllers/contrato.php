...
class Contrato extends Base {
    ...
    public function __construct(){
        ...
        $this->load->model('tcom-contrato/ordem_model','ordem');
        ...
        $this->load->library('tcom/bibcontrato', '', 'bibcontrato');
    ...
    public function pesq(){
        ...
        $crud['perAnaliseFinanceira'] = self::perAnaliseFinanceira;
    ...
    public function ficha($id = false){
        ...
        $dados['servicos'] = $this->contrato->servicosAtivos($dados['idServico']);   
    ...
    */
    ...
    public function alteraStatus(){
        ...
        if($status){
            if($this->input->post('status') == 'I'){
                $this->bibcontrato->emailDesconexao($this->input->post('id'));
            }
    ...
    public function pdf(){
        ...
        $arquivo = $this->imprimirAnaliseFin(1412,'htmlEmail');
