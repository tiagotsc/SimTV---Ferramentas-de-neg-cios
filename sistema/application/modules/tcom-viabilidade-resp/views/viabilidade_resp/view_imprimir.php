  ...
  <body>
            ...
            <table class="table">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><strong>Cidade:</strong> <?php echo htmlentities($viab['operadoraInst']->cidade); ?></td>
                        <td><strong>Cidade:</strong> <?php echo htmlentities($viab[$clienteEnd]->cidade); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><strong></strong> </td>
                        <td><strong>Complemento:</strong> <?php echo $viab[$clienteEnd]->complemento; ?></td>
                    </tr>
                </table>
