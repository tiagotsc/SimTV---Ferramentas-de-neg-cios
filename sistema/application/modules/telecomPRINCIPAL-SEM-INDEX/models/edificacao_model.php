...
class Edificacao_model extends CI_Model{
    ...
    public function pesquisa($parametros, $mostra_por_pagina, $sort_by, $sort_order, $pagina){
        ...
        $dados['dados'] = $this->db->get('sistema.tcom_edificacao', $mostra_por_pagina, $pagina)->result();           
    ...
    public function qtdLinhas($parametros = null){
        ...
        return $this->db->get('sistema.tcom_edificacao')->num_rows(); 
    ...
    public function permissorTemNode(){
        ...
        $sql = "SELECT 
                ...
                INNER JOIN tcom_node ON tcom_node.cd_unidade = unidade.cd_unidade";
    ...
    public function proximoControle($mes){
        ...
        $qtd = $this->db->count_all_results('sistema.tcom_edificacao');
        return $qtd + 1;
    ...
    public function existeEndereco(){
        ...
        return $this->db->get('sistema.tcom_edificacao')->result();
    ...
    public function dadosEdificacao($id){
        ...
        $sql = "SELECT 
                	...
                	ted.concluido,
                	ted.observacao
                FROM sistema.tcom_edificacao AS ted
                LEFT JOIN adminti.unidade AS tunidade ON tunidade.cd_unidade = ted.cd_unidade
                LEFT JOIN sistema.tcom_node AS tnode ON tnode.id = ted.idNode
    ...
    public function aval(){
        return $this->db->get('sistema.tcom_aval')->result();
    }
