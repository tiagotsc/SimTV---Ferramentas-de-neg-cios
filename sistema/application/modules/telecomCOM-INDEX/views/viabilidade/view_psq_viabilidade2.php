...
<style type="text/css">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="apg_tb" name="apg_tb" value="<?php echo $controller; ?>" />
    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <div style="float: left;" id="corpo" class="col-md-10 col-sm-9">
            <!--<div class="col-lg-12">-->
                
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url('home/inicio'); ?>">Principal</a></li>
                    <li><a href="#"><?php echo ucfirst($pasta); ?></a></li>
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open($pasta.'/'.$controller.'/'.$metodo,$data);
                            ...
                            $botaoCadastrar = (in_array(203, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/'.$controller.'/ficha'.ucfirst($controller))."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                ...
                foreach($dados as $da){
                    ...
                    $nome = $da->$campos[1].' - '.$da->$campos[2];
                    
                    foreach($campos as $campo => $valor){
                        
                        if($campo != $id){
                            $cell[$contCell++] = array('data' => html_entity_decode($da->$valor));
                        }
                    ...
                    $botaoEditar = '<a title="Editar" href="'.base_url($pasta.'/'.$controller.'/ficha'.ucfirst($controller).'/'.$da->$pk).'" class="glyphicon glyphicon-pencil"></a>';
                    $botaoExcluir = '<a title="Apagar" href="#" data-toggle="modal" data-target="#apaga" key="'.$da->$pk.'" nome="'.$nome.'" class="del glyphicon glyphicon-remove"></a>';
