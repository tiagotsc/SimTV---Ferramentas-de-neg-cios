    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <!--<div class="col-lg-12">-->
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url('tcom'); ?>">Telecom</a></li>
                    <li><a href="<?php echo base_url($modulo.'/'.$controller.'/pesq'); ?>"><?php echo 'Equipamento - '.strtolower($assunto); ?></a></li>
                ...
                <div id="divMain">
                    <?php
                        ...
                        $identificacao = (isset($identificacao))? $identificacao: false;
                    	...
                    	echo form_open($pasta.'/'.$controller.'/pesq',$data);
                            ...
                            $botaoMarca = (in_array($perEditarCadastrar, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/equipMarca/pesq')."' class='linkDireita'>Marcas&nbsp<span class='glyphicon glyphicon-search'></span></a>": '';
                            $botaoCadastrar = (in_array($perEditarCadastrar, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/'.$controller.'/ficha')."' class='linkDireita'>Cadastrar modelo&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                            
                    		echo form_fieldset($titulo.$botaoCadastrar.$botaoMarca, $attributes);
                                ...
                                echo '<div class="row">';
                                    ...
                                    foreach($marcas as $mar){
                                        $options[$mar->id] = $mar->nome;
                                    }		
                            		echo form_label('Marca', 'idEquipMarca');
                            		echo form_dropdown('status', $options, $idEquipMarca, 'id="idEquipMarca" class="form-control"');
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-4">';
                                    echo form_label('Modelo', 'nome');
                        			$data = array('name'=>'nome', 'value'=>$nome,'id'=>'nome', 'placeholder'=>'Digite nome', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-4">';
                                    echo form_label('Identificação', 'identificacao');
                        			$data = array('name'=>'identificacao', 'value'=>$identificacao,'id'=>'identificacao', 'placeholder'=>'Digite o código', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-4">';
                                    $options = array(''=>'', 'S' => 'Sim', 'N' => 'Não');		
                            		echo form_label('Associado ao contrato', 'contrato');
                            		echo form_dropdown('contrato', $options, $contrato, 'id="contrato" class="form-control"');
                                    echo '</div>';
