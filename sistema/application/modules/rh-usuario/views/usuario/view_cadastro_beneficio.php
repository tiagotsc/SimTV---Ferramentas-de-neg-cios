 ...
 */
?>
<div class="modal fade" id="benefifios" tabindex="-1" role="dialog">
                                        ...
                                        echo form_open('rh-beneficio/beneficio/cadastraBeneficio',$data);
                                            ...
                                            echo '<div class="col-md-4">';
                                                ...
                                                foreach($passagens as $passagem){
                                                    $opc[$passagem['id']] = $passagem['passagens'] . ' passagens';
                                                }
                                        ...
                                        echo form_open('rh-beneficio/beneficio/cadastraBeneficio',$data);
                                            ...
                                            echo form_hidden('cd_usuario', $cd_usuario);
                                                ...
                                                echo '<div class="col-md-4">';
                                                    ...
                                                    echo form_label('Passagens','passagens');
                                                    echo form_dropdown('id_passagem', $opc, $vale_transporte['id_passagem'], 'class="form-control numeroPassagem numeroPassagem"');
                                                echo '</div>';
