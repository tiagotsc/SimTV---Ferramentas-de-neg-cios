    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <!--<div class="col-lg-12">-->
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url('tcom'); ?>"><?php echo htmlentities(strtolower($assunto)); ?></a></li>
                    <li class="active"><?php echo $titulo; ?></li>
                </ol>
                <div id="divMain">
                    <?php
                        
                        $velocidade = (isset($velocidade))? $velocidade: false;
                    	...
                    	echo form_open($pasta.'/'.$controller.'/pesq',$data);
                            ...
                            $botaoCadastrar = (in_array($perEditarCadastrar, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/'.$controller.'/ficha')."' class='linkDireita'>NOVA&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                    		...
                    		echo form_fieldset($titulo.$botaoCadastrar, $attributes);
                                ...
                                echo '<div class="row">';
                                    ...
                                    echo form_label('Velocidade', 'velocidade');
                        			$data = array('name'=>'velocidade', 'value'=>$velocidade,'id'=>'velocidade', 'placeholder'=>'Digite a velocidade', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
