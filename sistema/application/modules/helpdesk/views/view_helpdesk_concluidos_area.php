            ...
            <div class="col-md-11">
                <div class="panel panel-primary">
                    <div class="panel-heading text-center">
                        <h3 id="tituloImpressao" class="panel-title">Chamados Conclu&iacutedos por &Aacuterea</h3>
                    </div>
...
//Escolha do Gráfico em Google Chart:
    function drawChart(chart_data) {
        ...
        var chart1_options = {
            legend: {position: 'top', 'alignment': 'center', textStyle: {fontSize: 10}, maxLines: 10},
            'width': 1000,
            'height': 390,
            pieHole: 0.2
...
//Ajax captura as informações do JSON + parâmetros do DatePicker:
        var jsonData = $.ajax({
            url: "/sistema/dashboard/helpdesk/dadosHelpDeskConcluidoArea/" + dataInicio + "/" + dataFinal,
            dataType: "json",
            async: false
        }).responseText;
