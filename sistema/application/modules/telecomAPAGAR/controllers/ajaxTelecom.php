...
class AjaxTelecom extends MX_Controller
{
     ...
     * 
	 */
    public function carregaNodesSiga(){ # COPIADO
    ...
    public function dadosNovoAssinante(){ # COPIADO
    ...
    public function dadosAssinanteMudancaEndereco(){ # COPIADO
    ...
    public function existeEndereco(){ # COPIADO
