...
<div class="col col-md-12 md-offset-3 col-sm-3 main">
    ...
    <div class="row-fluid col col-md-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Ativo - Chamadas - Intelig</li>
        </ol>
...
<script type="text/javascript">
    ...
    function load_page_data(dataInicio = '', dataFinal = ''){
        ...
        var tituloPBX = 'Ativo - Chamadas - Intelig ';
        ...
        var jsonData = $.ajax({
            url: "/sistema/dashboard/telefonia/dadosTelefoniaAtivoIntelig/" + dataInicio + "/" + dataFinal,
            dataType: "json",
            async: false
        }).responseText;
