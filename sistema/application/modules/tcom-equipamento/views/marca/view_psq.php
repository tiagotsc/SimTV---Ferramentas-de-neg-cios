                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open($pasta.'/'.$controller.'/pesq',$data);
                            ...
                            $botaoModelo = (in_array($perEditarCadastrar, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/equipModelo/pesq')."' class='linkDireita'>Modelos&nbsp<span class='glyphicon glyphicon-search'></span></a>": '';
                            $botaoCadastrar = (in_array($perEditarCadastrar, $this->session->userdata('permissoes')))? "<a href='".base_url($pasta.'/'.$controller.'/ficha')."' class='linkDireita'>Cadastrar marca&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                            
                    		echo form_fieldset($titulo.$botaoCadastrar.$botaoModelo, $attributes);
