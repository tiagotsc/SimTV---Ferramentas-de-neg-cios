...
#Banco FreePBX - Niteroi, RJ
$db['asteriskpbx']['hostname'] = '192.168.150.212';
$db['asteriskpbx']['username'] = 'suporte';
$db['asteriskpbx']['password'] = 'S1mTV@dmMysql';
$db['asteriskpbx']['database'] = 'asteriskcdrdb';
$db['asteriskpbx']['dbdriver'] = 'mysqli';
$db['asteriskpbx']['dbprefix'] = '';
$db['asteriskpbx']['pconnect'] = TRUE;
$db['asteriskpbx']['db_debug'] = TRUE;
$db['asteriskpbx']['cache_on'] = FALSE;
$db['asteriskpbx']['cachedir'] = '';
$db['asteriskpbx']['char_set'] = 'utf8';
$db['asteriskpbx']['dbcollat'] = 'utf8_general_ci';
$db['asteriskpbx']['swap_pre'] = '';
$db['asteriskpbx']['autoinit'] = TRUE;
$db['asteriskpbx']['stricton'] = FALSE;
