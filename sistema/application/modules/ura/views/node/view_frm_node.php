                ...
                <div id="divMain">
                    <?php   #echo '<pre>'; print_r($permissor); exit();
                    	...
                    	echo form_open('ura/salvarNode',$data);
                    		...
                    		echo form_fieldset("Ficha node<a href='".base_url('ura/ura/pesq')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
                                ...
                                echo '<div class="row">';
                            		...
                            		echo form_label('Tipo evento<span class="obrigatorio">*</span>', 'tipo');
                                ...
                                echo '<input type="hidden" id="todos_node" name="todos_node" />';
...
$("#dados_node").change(function(){
    
    var todos = '';
    if($(this).val() == 'todos'){
    
        var arr = [];
        $("#dados_node > option").each(function(){
            if($(this).val() != '' && $(this).val() != 'todos'){
                arr.push($.trim($(this).val()));
            }
        });
        todos = implode_js(',',arr);
    
    }
    $("#todos_node").val(todos);
