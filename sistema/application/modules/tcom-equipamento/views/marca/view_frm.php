                ...
                <div id="divMain">
                    <?php   
                    	...
                    	echo form_open($modulo.'/'.$controller.'/salvar',$data);
                    		...
                    		echo form_fieldset("Ficha equipamento - ".$assunto."<a href='".base_url($modulo.'/'.$controller.'/pesq')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisa marca</a>", $attributes);
