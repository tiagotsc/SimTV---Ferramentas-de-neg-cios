...
class taxaDigital extends Base {
     
     private $logDados;
     const modulo = 'tcom-taxa-digital';
     const controller = 'taxaDigital';
     const pastaView = 'taxaDigital';
     const tabela = 'tcom_taxa_digital';
     const assunto = 'Taxa digital';
     const modelAssunto = 'taxaDigital';
     const perModulo = 274;
     const perPesq = 313;
     const perCadEdit = 314;
     const perDeletar = 315;
    ...
    public function __construct(){
        ...
        $this->load->model('taxaDigital_model',self::modelAssunto);
