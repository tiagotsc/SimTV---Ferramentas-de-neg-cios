                    		...
                    		echo form_fieldset("Ficha ".$assunto."<a href='".base_url($modulo.'/'.$controller.'/pesq')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
                              ...
                              echo '</div>';
                                ...
                                echo '<div class="novo-cliente row">';
                                    ...
                                    echo '<div id="nome_cliente" class="col-md-10">';
                                    echo form_label('Nome', 'titulo');
                        			$data = array('name'=>'titulo', 'value'=>'','id'=>'titulo', 'placeholder'=>'Informe o nome.', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-2">';
                                    $options = array('' => '');		
                                    foreach($clientesTipo as $cliTipo){
                                        $options[$cliTipo->id] = htmlentities($cliTipo->nome);
                                    }		
                            		echo form_label('Tipo cliente', 'idClienteTipo');
                            		#echo form_dropdown('cd_estado', $options, $cd_estado, 'readonly="readonly" id="cd_estado" class="form-control"');
                                    echo form_dropdown('idClienteTipo', $options, $idClienteTipo, 'id="idClienteTipo" class="form-control"');
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-2">';
                                    echo form_label('CEP<span class="obrigatorio">*</span>', 'cep');
                        			$data = array('name'=>'cep', 'value'=>'','id'=>'cep', 'placeholder'=>'Informe o CEP', 'class'=>'cep form-control');
                        			echo form_input($data);
                                    echo '</div>';
                            		...
                            		#echo form_dropdown('cd_estado', $options, $cd_estado, 'readonly="readonly" id="cd_estado" class="form-control"');
                                    echo form_dropdown('cd_estado', $options, '', 'id="cd_estado" class="form-control"');
                                    echo '</div>';  
                                    
                                    echo '<div class="col-md-6">';
                                    echo form_label('Endereço<span class="obrigatorio">*</span>', 'endereco');
                        			$data = array('name'=>'endereco', /*'readonly'=>'readonly',*/ 'value'=>'','id'=>'endereco', 'placeholder'=>'Informe o endereço', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-2">';
                                    echo form_label('Número', 'numero');
                        			$data = array('name'=>'numero', 'value'=>'','id'=>'numero', 'placeholder'=>'Informe o número', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    echo form_label('Bairro<span class="obrigatorio">*</span>', 'bairro');
                        			$data = array('name'=>'bairro', /*'readonly'=>'readonly',*/ 'value'=>'','id'=>'bairro', 'placeholder'=>'Informe o bairro', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    echo form_label('Cidade<span class="obrigatorio">*</span>', 'cidade');
                        			$data = array('name'=>'cidade', /*'readonly'=>'readonly',*/ 'value'=>'','id'=>'cidade', 'placeholder'=>'Informe o cidade', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-6">';
                                    echo form_label('Complemento', 'complemento');
                        			$data = array('name'=>'complemento', 'value'=>'','id'=>'complemento', 'placeholder'=>'Informe o complemento', 'class'=>'form-control');
                        			echo form_input($data);
                                    echo '</div>';
                                    ...
                                    if($telefones){
                                        ...
                                        foreach($telefones as $telefone){
                                			...
                                			$data = array('name'=>'telefone[]', 'value'=>'','id'=>'telefone[]', 'maxlength' => 14, 'placeholder'=>'Informe o telefone', 'class'=>'telefone form-control');
                                			echo form_input($data);
                                            echo '</div>';
...
$("#idViabTipo").change(function(){
   ...
   // Ativação, Darkfiber ou Co-Location
   ...
   // Upgrade ou Downgrade, outras mudanças
   ...
   // Se for upgrade, downgrade ou mudança de endereço, outras mudanças
   // Obriga a seleção de contrato
   if($(this).val() == '2' || $(this).val() == '3' || $(this).val() == '5' || $(this).val() == '6'){
...
$(document).ready(function(){ 
   ...
   // Ativação, Darkfiber ou Co-Location
   if($("#idViabTipo").val() == '1' || $("#idViabTipo").val() == '4' || $("#idViabTipo").val() == '7'){
    ...
    // Upgrade, downgrade
    if($("#idViabTipo").val() == '2' || $("#idViabTipo").val() == '3' || $(this).val() == '6'){
        segundoDesbloqueio();
    }
    
    //Upgrade, downgrade, mudança de endereço
    if($("#idViabTipo").val() == '2' || $("#idViabTipo").val() == '3' || $("#idViabTipo").val() == '5' || $(this).val() == '6'){
        $(".contrato").show();
    }
