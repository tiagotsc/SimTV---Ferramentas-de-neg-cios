                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">                      
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr><th colspan="7"><strong>Base com sinal</strong></th></tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td></td>
                                                    <td><strong><?php echo date('d/m/Y', strtotime("-2 days")); ?></strong></td>
                                                    <td><strong>% Desvio</strong></td>
                                                    <td><strong><?php echo date('d/m/Y', strtotime("-1 days")); ?></strong></td>
                                                    <td><strong>% Desvio</strong></td>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAcCs->PRODUTO; ?></strong></td>
                                                    <td><?php echo number_format($bAcCs->DIAS_ATRAS_3, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcCs->DIF_PORC_3; ?>%</td>
                                                    <td><?php echo number_format($bAcCs->DIAS_ATRAS_2, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcCs->DIF_PORC_2; ?>%</td>
                                                    <td><?php echo number_format($bAcCs->DIAS_ATRAS_1, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcCs->DIF_PORC_1; ?>%</td>
                                                </tr>
                                                <?php 
                                                } 
                                                ?>
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr><th colspan="6">Base sem sinal<br /> <span style="font-size: 13px;"><?php echo date("d-M"); ?></span></th></tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td></td>
                                                    <td><strong>At&eacute; 5 dias</strong></td>
                                                    <td><strong>D&ecirc; 6 &agrave; 15 dias</strong></td>
                                                    <td><strong>D&ecirc; 16 &agrave; 59 dias</strong></td>
                                                    <td><strong>Acima 60 dias</strong></td>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAcSs->PRODUTO; ?></strong></td>
                                                    <td><?php echo $bAcSs->ATE5DIAS; ?></td>
                                                    <td><?php echo $bAcSs->DE6A15DIAS; ?></td>
                                                    <td><?php echo $bAcSs->DE16A59DIAS; ?></td>
                                                    <td><?php echo $bAcSs->ACIMA60DIAS; ?></td>
                                    ...
                                    <div class="col-md-4">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr><th colspan="2"><strong>Movimenta&ccedil;&atilde;o da base</strong></th></tr>
                                            </thead>
                                            <tbody>
                                                <tr><td colspan="2" style="text-align: left;"><strong>Sa&iacute;da</strong></td></tr>
                                                <?php 
                                                $totalSaida = 0;
                                                ...
                                                ?>
                                                <tr><td colspan="2" style="text-align: left;"><strong>Entrada</strong></td></tr>
                                                <?php 
                                                $totalEntrada = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo ($totalSaida > $totalEntrada)? $totalSaida-$totalEntrada: $totalEntrada-$totalSaida; ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="col-md-8">                      
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAcSi->PRODUTO; ?></strong></td>
                                                    <td><?php echo number_format($bAcSi->DIAS_ATRAS_3, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSi->DIF_PORC_3; ?>%</td>
                                                    <td><?php echo number_format($bAcSi->DIAS_ATRAS_2, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSi->DIF_PORC_2; ?>%</td>
                                                    <td><?php echo number_format($bAcSi->DIAS_ATRAS_1, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSi->DIF_PORC_1; ?>%</td>
                                                </tr>
                                                <?php 
                                                } 
                                                ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAsSi->PRODUTO; ?></strong></td>
                                                    <td><?php echo $bAsSi->ATE5DIAS; ?></td>
                                                    <td><?php echo $bAsSi->DE6A15DIAS; ?></td>
                                                    <td><?php echo $bAsSi->DE16A59DIAS; ?></td>
                                                    <td><?php echo $bAsSi->ACIMA60DIAS; ?></td>
                                                    <td><?php echo number_format($total, 0, ',', '.'); ?></td>
                                                </tr>
                                                <?php
                                                }
                                    ...
                                    <div class="col-md-8">                      
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAcSf->PRODUTO; ?></strong></td>
                                                    <td><?php echo number_format($bAcSf->DIAS_ATRAS_3, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSf->DIF_PORC_3; ?>%</td>
                                                    <td><?php echo number_format($bAcSf->DIAS_ATRAS_2, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSf->DIF_PORC_2; ?>%</td>
                                                    <td><?php echo number_format($bAcSf->DIAS_ATRAS_1, 0, ',', '.'); ?></td>
                                                    <td><?php echo (float)$bAcSf->DIF_PORC_1; ?>%</td>
                                                </tr>
                                                <?php 
                                                } 
                                                ?>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><strong><?php echo $bAsSf->PRODUTO; ?></strong></td>
                                                    <td><?php echo $bAsSf->ATE5DIAS; ?></td>
                                                    <td><?php echo $bAsSf->DE6A15DIAS; ?></td>
                                                    <td><?php echo $bAsSf->DE16A59DIAS; ?></td>
                                                    <td><?php echo $bAsSf->ACIMA60DIAS; ?></td>
                                                    <td><?php echo number_format($total, 0, ',', '.'); ?></td>
                                                </tr>
                                                <?php
                                                }
