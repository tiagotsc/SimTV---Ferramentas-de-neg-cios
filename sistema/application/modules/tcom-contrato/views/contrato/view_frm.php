...
<script type="text/javascript" src="<?php echo base_url('assets/js/jquery.blockui/jquery.block.ui.js') ?>"></script>
            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    <div>
                        <a style="font-size: 21px;" href="<?php echo base_url($modulo.'/'.$controller.'/pesq'); ?>" class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>Voltar</a>
                    </div>
                    <div>
                    <?php
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities($unidade_permissor.' - '.$unidade_nome); ?></td>
                    ...
                    if(in_array($perVigencia, $this->session->userdata('permissoes'))){
                    	...
                    	echo form_open($modulo.'/'.$controller.'/alteraVigencia',$data);
                    		...
                    		echo form_fieldset("Vigência", $attributes);
                                ...
                                echo '<div class="row">';
                        			...
                        			$data = array('name'=>'data_inicio', 'value'=>$this->util->formataData($data_inicio,'BR'),'id'=>'data_inicio', /*'readonly' => 'readonly',*/ 'class'=>'form-control data');
                        			echo form_input($data);
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    echo form_label('Data fim<span class="obrigatorio">*</span>', 'data_fim');
                        			$data = array('name'=>'data_fim', 'value'=>$this->util->formataData($data_fim,'BR'),'id'=>'data_fim', /*'readonly' => 'readonly',*/ 'class'=>'form-control data');
                        			echo form_input($data);
                                    echo '</div>';
                                
                                    echo '<div class="col-md-3">';
                                    $options = array('' => '', '12' => '12', '24' => '24', '36' => '36', '60' => '60');		
                     ...
                     if(in_array($perServico, $this->session->userdata('permissoes'))){
                        $data = array('class'=>'pure-form','id'=>'frm-servico');
                    	echo form_open($modulo.'/'.$controller.'/alteraServico',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
             
                    		echo form_fieldset("Servi&ccedil;os", $attributes);
                    		
                                echo '<div class="row">';
                                    /*
                                    echo '<div class="col-md-3">';
                                    $options = array('' => '');
                                    foreach($servicosTipo as $servT){
                                        $options[$servT->id] = htmlentities($servT->nome);
                                    }		
                            		echo form_label('Tipo de servi&ccedil;o', 'idServicoTipo');
                            		echo form_dropdown('idServicoTipo', $options, $idServicoTipo, 'id="idServicoTipo" class="form-control"');
                                    echo '</div>';
                                    */
                                    echo '<div class="col-md-3">';
                                    $options = array('' => '');	
                                    foreach($servicos as $serv){
                                        $options[$serv->id] = htmlentities($serv->nome);
                                    }		
                            		echo form_label('Servi&ccedil;o', 'idServico');
                    	...
                    	echo form_open($modulo.'/'.$controller.'/alteraStatus',$data);
                    		...
                    		echo form_fieldset("Status", $attributes);
                                ...
                                echo '<div class="row">';
                                    ...
                                    echo '<div class="col-md-4 dt_canc">';
                                    echo form_label('Data solicitação cancelamento', 'data_solic_canc');
                        			$data = array('name'=>'data_solic_canc', 'value'=>$this->util->formataData($data_solic_canc,'BR'),'id'=>'data_solic_canc', /*'readonly'=>'readonly',*/ 'class'=>'form-control data');
                        			echo form_input($data);
                                    echo '</div>'; 
                                    
                                    echo '<div class="col-md-4 dt_canc">';
                                    echo form_label('Data cancelamento', 'data_canc');
                        			$data = array('name'=>'data_canc', 'value'=>$this->util->formataData($data_canc,'BR'),'id'=>'data_canc', /*'readonly'=>'readonly',*/ 'class'=>'form-control data');
                        			echo form_input($data);
                                    echo '</div>';    
