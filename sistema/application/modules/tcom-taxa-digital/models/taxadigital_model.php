 ...
 * Dashboard_model
 * 
 * Classe que realiza o tratamento do módulo da taxa digital
 * 
 * @package   
 ...
 * @access public
 */
class TaxaDigital_model extends CI_Model{
	
    const tabela = 'tcom_taxa_digital';
    
	/**
	 * TaxaDigital_model::__construct()
	 * 
	 * @return
	 */
    ...
    public function taxas($id = false){
        ...
        $this->db->order_by('velocidade', 'asc');
    ...
    public function pesquisa($parametros, $mostra_por_pagina, $sort_by, $sort_order, $pagina){
        ...
        $this->db->select("
                        	id,
                        	CONCAT(velocidade,' ', tipo) AS velocidade,
                            mnemonico,
        ...
        $dados['campos'] = array('id', 'Velocidade', 'Mnemonico', 'Status');
