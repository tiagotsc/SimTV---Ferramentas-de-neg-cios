<?php 
include_once('equipModelo.php');
if ( ! defined('BASEPATH')) exit('No direct script access allowed');

class equipMarca extends equipModelo {
     
     private $logDados;
     #const modulo = 'tcom-equipamento';
     const controller = 'equipMarca';
     const pastaView = 'marca';
     const tabela = 'tcom_equip_marca';
     const assunto = 'Marca';
     const modelAssunto = 'equiMarca';
     #const perModulo = 274;
     #const perPesq = 304;
    ...
    public function __construct(){
        ...
        $this->load->model('equipMarca_model',self::modelAssunto);
