// Armazena o último usuário online para evitar duplicação de notificação de status
var ultimoUserStatus = '';
// Armazena o último cd da mensagem aberta na hora de abrir o chat
var ultimaCdMsgAbreChat = '';
/* # Controla a verificação por segundos para não atropelar verificação */
var verifEmAndamento = false;
...
$("#div-msg-anterior span").click(function(){
   ...
   $.ajax({
          ...
          error: function(res) {
            //alert(res.status);
            $("#feedback").html('Aperte F5 - Erro ao carregar anteriores');
          },
    ...
    function(){
        ...
        if(!verifEmAndamento){
            ...
            $.ajax({
              ...
              error: function(res) {
                //alert(res.status);
                $("#feedback").html('Aperte F5 - Erro ao status do usuario');
              },
              success: function(res) {
                    ...
                    $.each(res, function(){
                        ...
                        if(this.status_chat_usuario == 'ONLINE'){
                            ...
                            if($('select[name=chatStatus]').val() != 'OFFLINE'){
                                ...
                                if((this.cd_usuario+this.status_chat_usuario) != ultimoUserStatus){
                        ...
                        ultimoUserStatus = this.cd_usuario+this.status_chat_usuario;
            ...
            $.ajax({
              ...
              error: function(res) {
                //alert(dump(res));
                $("#feedback").html('Aperte F5 - Erro verificar qtd msgs');
              },
              success: function(res) {
                ...
                $.each(res, function() { 
                    ...
                    if(!$(".new-msg"+this.cd_origem).length && this.cd_origem != sessionUserId){
                        ...
                        htmlRecentes = '<li id="recentId'+this.cd_usuario+'" class="clearfix ui-state-default">';
                        ...
                        $("#recentId"+this.cd_usuario).prependTo( "#recentes" );
            ...
            if($("#user-conversa").attr("idUsuarioConversa") != ''){
                $.ajax({
                  ...
                  error: function(res) {
                    //alert(res.status);
                    $("#feedback").html('Aperte F5 - Erro ao carregar novas msgs');
                  },
                  success: function(res) {
                    ...
                    if(res.length > 0){
                        ...
                        $.each(res, function() {
                            ...
                            var msgConteudo = '<li class="nao-lida" idMsg="'+this.cd_chat_msg+'" >';
                                ...
                                if(!$("li[idMsg='"+this.cd_chat_msg+"']").length){
...
$("#chat-search").keyup(function(){
    ...
    if($(this).val() != ''){
        $.ajax({
          ...
          error: function(res) {
            //alert('erro');
            $("#feedback").html('Aperte F5 - Erro pesquisar usuario');
          },
          success: function(res) {
          
            if(res.length > 0){
                var resPesq = '<h5 class="tituloDp"><strong>Pesquisa</strong></h5>';
...
$("#chatStatus").change(function(){
   if($(this).val() != ''){
        ...
        $.ajax({
          ...
          error: function(res) {
            //alert(res.status);
            $("#feedback").html('Aperte F5 - Erro ao atualizar seu status');
          },
          success: function(res) {
            //alert(res.status);
          }
    ...
    drop: function(event, ui){
        ...
        */
        ...
        $.ajax({
          ...
          error: function(res) {
            //alert(res.status);
            $("#feedback").html('Aperte F5 - Erro arrastar para favoritos');
          },
          success: function(res) {
            //alert(res.status);
        ...
        drop: function(event, ui){
            ...
            */
            ...
            $.ajax({
              ...
              error: function(res) {
                //alert(res.status);
                $("#feedback").html('Aperte F5 - Erro arrastar tirando de favoritos');
              },
              success: function(res) {
                //alert(res.status);
...
$.fn.abreChat = function(id, tipo) {
    ...
    $.ajax({
      ...
      error: function(res) {
        ...
        $("#feedback").html('Aperte F5 - Erro abrir conversa do chat');
      },
      success: function(res) {
        ...
        if(res.msgs.length > 0){
            ...
            $.each(res.msgs, function() {
                ...
                if(this.cd_chat_msg != ultimaCdMsgAbreChat){
                
                    $("#chat-msg-historico").append(msgConteudo);
                
                }
                
                ultimaCdMsgAbreChat = this.cd_chat_msg;
            ...
            if(conversaRecente != id){
                ...
                $('.chat-history').scrollTop($(".nao-lida:first").offset().top);
    ...
    if(idMsgs != ''){
        ...
        $.ajax({
          ...
          error: function(res) {
            //alert(res.status);
            //dump(res);
            $("#feedback").html('Aperte F5 - Erro ao verificar nao lidas');
          },
          success: function(res) {
            //alert(res.status);
          }
...
$("#chat-btn-enviar").click(function(){
    ...
    */
    ...
    var conteudoEscrita = $('div[contenteditable=true]').html();
    ...
    if(conteudoEscrita != ''){
        ...
        $.ajax({
          ...
          data: {
            ...
            mensagem: conteudoEscrita,
            mensagem_tipo: 'texto'
          },
          dataType: "json",
          error: function(res) {
            //alert('Mensagem não enviada');
            $("#feedback").html('Aperte F5 - Erro mensagem nao enviada');
          },
          success: function(res) {
            ...
            if(!$("li[idMsg='"+res.cd_chat_msg+"']").length){
                $("#chat-msg-historico").append(msgConteudo);
            }
