...
class Usuario extends Base
{
    ...
    public function usuarios(){
        ...
        $this->layout->region('html_header', 'view_html_header');
        $this->layout->region('menu_lateral', 'view_menu_lateral');
        $this->layout->region('corpo', 'usuario/view_psq_usuario');
      	$this->layout->region('rodape', 'view_rodape');
      	$this->layout->region('html_footer', 'view_html_footer');
     ...
     * @return
     */
    public function pesquisar($matricula = null, $nome = null, $status = 'A', $sort_by = 'nome', $sort_order = 'asc', $pagina = null){
        ...
        $dados['usuarios'] = $this->usuario->psqUsuarios($dados['postMatricula'], $dados['postNome'], $dados['postStatus'], $pagina, $mostra_por_pagina, $campoSortBy, $sort_order);   
        $dados['qtdUsuarios'] = $this->usuario->psqQtdUsuarios($dados['postMatricula'], $dados['postNome'], $dados['postStatus']); 

        $dados['sort_by'] = $sort_by;
		$dados['sort_order'] = $sort_order;                    
        
        $config['base_url'] = base_url('usuario/pesquisar/'.$dados['postMatricula'].'/'.$dados['postNome'].'/'.$dados['postStatus'].'/'.$sort_by.'/'.$sort_order); 
