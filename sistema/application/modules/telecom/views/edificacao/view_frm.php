            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    ...
                    #echo date('N', strtotime(date('2016-04-05')));
                        ...
                        echo form_open_multipart('telecom/edificacao/salvarEdificacao',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
             
                    		echo form_fieldset("Ficha edifica&ccedil;&atilde;o<a href='".base_url('telecom/edificacao/pesqEdificacao')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
...
$.fn.existeEndereco = function() {  
    $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>telecom/ajaxTelecom/existeEndereco',
      data: {
        <?php if($id){ ?>
        id: <?php echo $id;?>,
        <?php } ?>
      ...
      success: function(res) {
        if(res.length > 0){
            ...
            $.each( res, function() {
              links += '<strong><a target="_blank" href="<?php echo base_url('telecom/edificacao/fichaEdificacao'); ?>/'+this.id+'">Contrato - '+this.contrato+'</a></strong><br>';
            });
...
$(document).ready(function(){ 
    ...
    $("#pesq").click(function(){
        ...
        if($("#cd_unidade").val() == '' || $("#origem").val() == '' || $("#contrato").val() == ''){
            ...
            $.ajax({
              type: "POST",
              url: '<?php echo base_url(); ?>telecom/ajaxTelecom/'+urlParte,
              data: {
                permissor: perm[0],
