                ...
                <div id="divMain">
                    ...
                    if($termo){
                        ...
                        foreach($termo as $te){
                            ...
                            $cell5 = array('data' => '<a title="Gerar e enviar termo" href="#" onclick="termo('.$da->cd_telefonia_emprestimo.')" data-toggle="modal"  data-target="#termo" class="'.$corTermo.' glyphicon glyphicon glyphicon-list-alt"></a>');
