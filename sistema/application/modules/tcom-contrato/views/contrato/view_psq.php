    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <!--<div class="col-lg-12">-->
                ...
                foreach($dados as $da){
                    ...
                    $botaoValor = (in_array($perValores, $this->session->userdata('permissoes')))? '<a title="Valor" href="#" data-toggle="modal" data-target="#valores" key="'.$da->$pk.'" nome="'.$da->numero.'" class="valoresDados glyphicon glyphicon-usd"></a>': '';
