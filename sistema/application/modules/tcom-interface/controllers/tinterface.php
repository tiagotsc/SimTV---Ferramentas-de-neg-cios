...
class tinterface extends Base {
     
     private $logDados;
     const modulo = 'tcom-interface';
     const controller = 'tinterface';
     const pastaView = 'tinterface';
    ...
    public function __construct(){
        ...
        $this->load->model('tinterface_model',self::modelAssunto);
