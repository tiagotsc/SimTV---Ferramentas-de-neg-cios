            ...
            <div class="col-md-11">
                <div class="panel panel-primary">
                    <div class="panel-heading text-center">
                        <h3 id="tituloImpressao" class="panel-title">Chamados Conclu&iacutedos por Unidade</h3>
                    </div>
...
//Ajax captura as informações do JSON + parâmetros do DatePicker:
        var jsonData = $.ajax({
            url: "/sistema/dashboard/helpdesk/dadosHelpDeskConcluidoUnidade/" + dataInicio + "/" + dataFinal,
            dataType: "json",
            async: false
        }).responseText;
