...
$this->session->set_userdata('current_menu_pbx', 7);
?>
...
<html lang="en">
    ...
    <div class="col col-md-12 md-offset-3 col-sm-3 main">
        ...
        <div class="row-fluid col col-md-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Trid&iacutegito</li>
            </ol>
    ...
    <script type="text/javascript">
        ...
        function load_page_data(dataInicio = '', dataFinal = ''){
            ...
            var tituloPBX = 'Receptivo - Tridigito ';
            if (dataInicio === dataFinal) {
                $('#tituloAsterisk').text(tituloPBX + ' <' + dataInicio + '>');
            } else {
            ...
            var jsonData = $.ajax({
                url: "/sistema/dashboard/telefonia/dadosTelefoniaTridigito/" + dataInicio + "/" + dataFinal,
                dataType: "json",
                async: false
            }).responseText;
