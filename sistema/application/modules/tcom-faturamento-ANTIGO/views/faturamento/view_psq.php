            ...
            <!--<div class="col-lg-12">-->
                ...
                <div id="divMain">
                    <?php
                        ...
                        $idOperCobrPai = (isset($idOperCobrPai))? $idOperCobrPai: false;
                        $competencia = (isset($competencia))? $competencia: false;
                    	...
                    	echo form_open($pasta.'/'.$controller.'/pesq',$data);
                    		...
                    		echo form_fieldset($titulo.$botaoCadastrar, $attributes);
                                ...
                                echo '<div class="row">';
                                    ...
                                    $options = array(''=>'','N'=>'NAO DEFINIDO');	
                                    foreach($gruposFaturados as $gruposF){
                                        $options[$gruposF->id] = htmlentities($gruposF->titulo);
                                    }	
                            		echo form_label('Grupo', 'idOperCobrPai');
                            		echo form_dropdown('idOperCobrPai', $options, $idOperCobrPai, 'id="idOperCobrPai" class="form-control"');
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    $options = array(''=>'');	
                                    foreach($competenciasFaturadas as $compFat){
                                        $options[$compFat->competencia] = htmlentities($compFat->competencia_formatada);
                                    }	
                            		echo form_label('Compet&ecirc;ncia', 'competencia');
                            		echo form_dropdown('competencia', $options, $competencia, 'id="competencia" class="form-control"');
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    $options = array(''=>'', 'MENS' => 'Mensalidade', 'AVULSO' => 'Avulso');	
                            		echo form_label('Tipo t&iacute;tulo', 'tipo');
