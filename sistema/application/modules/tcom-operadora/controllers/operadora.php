...
class operadora extends Base {
    ...
    public function ficha($id = false){
        ...
        if($id){
            ...
            # DADOS FATURAMENTO
            $dadosRes = $this->crudModel->dadosIDSimples(BANCO_TELECOM.'.tcom_oper_fat','idOper',$id);
            $campos = array_keys($dadosRes);
            ...
            # DADOS FATURAMENTO
            $campos = $this->crudModel->camposTbSimples(BANCO_TELECOM.'.tcom_oper_fat');
        ...
        $dados['indiceReajuste'] = $this->contrato->indiceReajuste();
        $dados['regrasReajustes'] = $this->contratoValor->regrasReajustes();
