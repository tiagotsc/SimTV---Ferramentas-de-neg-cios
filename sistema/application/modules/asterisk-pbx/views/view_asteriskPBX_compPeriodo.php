...
$this->session->set_userdata('current_menu_pbx', 8);
?>
    ...
    <div class="col col-md-12 md-offset-3 col-sm-3 main">
        ...
        <div class="row-fluid col col-md-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Comparativo / Por Per&iacuteodo</li>
            </ol>
                ...
                <div class="col-md-11">
                    <div class="panel panel-primary">
                        <div class="panel-heading text-center">
                            <h3 id="tituloAsterisk" class="panel-title">Comparativo por Periodo</h3>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart(chart_data) {
            ...
            var chart1_options = {
                ...
                height: '250',
                colors: ['CornflowerBlue', 'DimGray']
            };
            var chart1_chart = new
                    google.visualization.ColumnChart(document.getElementById('graphTelefonia'));
        ...
        function load_page_data(dataInicio = '', dataFinal = ''){
            ...
            var tituloPBX = 'Comparativo por Periodo ';
            if (dataInicio === dataFinal) {
                $('#tituloAsterisk').text(tituloPBX);
            } else {
            ...
            var jsonData = $.ajax({
                url: "/sistema/dashboard/telefonia/dadosComparativoPorPeriodo/" + dataInicio + "/" + dataFinal,
                dataType: "json",
                async: false
            }).responseText;
