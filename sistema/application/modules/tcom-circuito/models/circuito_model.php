...
class Circuito_model extends CI_Model{
    ...
    */
    ...
    public function atualizaInterfaceVelocidade(){
        ...
        $sql = "UPDATE ".BANCO_TELECOM.".tcom_contrato_circuito SET idInterface=".$this->input->post('idInterface').", idTaxaDigital=".$this->input->post('idTaxaDigital')." \n WHERE idCircuito=".$this->input->post('idCircuito')." AND idContrato=".$this->input->post('idContrato');
        $this->db->query($sql);
